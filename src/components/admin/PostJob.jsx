    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-center w-full my-10 px-4 md:px-0">
                <form onSubmit={submitHandler} className="p-8 max-w-3xl w-full bg-white shadow-lg rounded-lg border border-gray-200">
                    ...
                    {loading ? (
                        <Button className="w-full my-4 flex items-center justify-center bg-blue-600 text-white hover:bg-blue-700 rounded-md" disabled>
                            <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                            Please wait...
                        </Button>
                    ) : (
                        <Button type="submit" className="w-full my-4 bg-blue-600 text-white hover:bg-blue-700 rounded-md">
                            Post New Job
                        </Button>
                    )}
                    {companies.length === 0 && (

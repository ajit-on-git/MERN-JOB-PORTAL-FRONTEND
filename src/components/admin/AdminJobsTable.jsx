...
const AdminJobsTable = () => {
    ...
    return (
        <div className="overflow-hidden bg-white shadow-md rounded-lg p-6">
            <Table>
                <TableCaption className="text-sm text-gray-600">A list of your recent posted jobs</TableCaption>
                <TableHeader>
                    <TableRow>
                        <TableHead className="text-left text-sm font-semibold text-gray-700">Company Name</TableHead>
                        <TableHead className="text-left text-sm font-semibold text-gray-700">Role</TableHead>
                                ...
                                <TableCell className="text-right">
                                    <Popover>
                                        ...
                                        <PopoverContent className="w-32 rounded-lg shadow-lg border border-gray-200 bg-white">
                                            <div onClick={() => navigate(`/admin/companies/${job._id}`)} className='flex items-center gap-2 w-fit cursor-pointer p-2 hover:bg-gray-100 rounded-md'>
                                                <Edit2 className='w-4 h-4' />
                                                <span className="text-sm text-gray-700">Edit</span>
                                            </div>
                                            <div onClick={() => navigate(`/admin/jobs/${job._id}/applicants`)} className='flex items-center w-fit gap-2 cursor-pointer mt-2 p-2 hover:bg-gray-100 rounded-md'>
